    ...
    class sessions{
        public function create_default_db(){
            ...
            mysqli_query($conn, "CREATE TABLE IF NOT EXISTS sessions(
                ...
                createddate int(8) NOT NULL,
                lastuseddate int(8) NOT NULL,
        ...
        public function add_session($accountid){
            ...
            mysqli_query($conn, "INSERT INTO sessions(ip, sessionid, accountid, createddate, lastuseddate, browser, browserVersion, platform) VALUES ('$ip', '$sessionid', '$accountid', '$time', '$time', '$browser', '$browserVersion', '$platform')");
        ...
        public function update_lastused($sessionid){
            ...
            $sessionid = mysqli_real_escape_string($conn, $sessionid);
            $time = time();
            mysqli_query($conn, "UPDATE sessions SET lastuseddate='$time' WHERE sessionid='$sessionid'");
            mysqli_close($conn);
        }
    }
?>
